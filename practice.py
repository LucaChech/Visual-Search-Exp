...
df = pd.DataFrame.from_csv('C:/Users/luca.chech.16/Desktop/jupyter exp/randomization_short.csv')
...
'\n'
'\n'
'   Press SPACEBAR to begin next block.',
alignHoriz='center',
alignVert='center',
height= 0.10,
wrapWidth=2 )
